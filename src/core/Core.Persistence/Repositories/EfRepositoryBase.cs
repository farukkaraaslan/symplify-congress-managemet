...
public class EfRepositoryBase<TEntity, TContext, TId>(TContext context) : IAsyncRepository<TEntity, TId>, IRepository<TEntity, TId>
    ...
    where TId : notnull
{
    ...
    public IQueryable<TEntity> Query() => Context.Set<TEntity>().Where(entity => entity.DeletedDate == null);
    ...
    private static void MarkAsDeleted(TEntity entity)
    {
