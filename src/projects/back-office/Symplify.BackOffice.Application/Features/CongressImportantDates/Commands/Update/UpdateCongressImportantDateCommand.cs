...
public class UpdateCongressImportantDateCommand
    : IRequest<UpdatedCongressImportantDateResponse>, ISecuredRequest, ICacheRemoverRequest
{
    ...
    /// Pozitif gönderilirse kayıt hedef sıraya taşınır ve kongreye ait liste normalize edilir.
    /// </summary>
    ...
    public class UpdateCongressImportantDateCommandHandler
        : IRequestHandler<UpdateCongressImportantDateCommand, UpdatedCongressImportantDateResponse>
    {
        ...
        public UpdateCongressImportantDateCommandHandler(
        ...
        public async Task<UpdatedCongressImportantDateResponse> Handle(
            UpdateCongressImportantDateCommand request,
            CancellationToken cancellationToken)
        {
            ...
            await _rules.ImportantDateShouldBelongToCongress(entity!, request.CongressId);
            ...
            CancellationToken cancellationToken)
        {
            ...
            List<CongressImportantDateTranslation> existingTranslations = _translationRepository
                .Query()
                .ToList()
                .Where(translation =>
                    EqualityComparer<Guid>.Default.Equals(translation.CongressImportantDateId, rootId) &&
            ...
            foreach (TranslationInputDto input in translations)
            {
                ...
                CongressImportantDateTranslation? existingTranslation = existingTranslations
        ...
        private async Task NormalizeVisibleOrdersAsync(
            CongressImportantDate currentEntity,
            int requestedOrder,
            CancellationToken cancellationToken)
        {
