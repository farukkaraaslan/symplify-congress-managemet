namespace Symplify.BackOffice.Application.Features.CongressImportantDates.Constants;
public static class CongressImportantDatesOperationClaims
{
    private const string Section = "CongressImportantDates";
