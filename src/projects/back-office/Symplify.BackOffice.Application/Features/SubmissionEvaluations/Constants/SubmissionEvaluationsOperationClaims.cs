namespace Symplify.BackOffice.Application.Features.SubmissionEvaluations.Constants;
public static class SubmissionEvaluationsOperationClaims
{
    private const string Section = "SubmissionEvaluations";
