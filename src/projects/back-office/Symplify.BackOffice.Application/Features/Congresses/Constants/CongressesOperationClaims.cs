namespace Symplify.BackOffice.Application.Features.Congresses.Constants;

public static class CongressesOperationClaims
{
    private const string Section = "Congresses";
