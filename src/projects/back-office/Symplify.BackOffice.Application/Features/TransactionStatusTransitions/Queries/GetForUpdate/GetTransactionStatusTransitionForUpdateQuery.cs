...
public class GetTransactionStatusTransitionForUpdateQuery : IRequest<GetTransactionStatusTransitionForUpdateResponse>, ISecuredRequest
{
    ...
    public class GetTransactionStatusTransitionForUpdateQueryHandler : IRequestHandler<GetTransactionStatusTransitionForUpdateQuery, GetTransactionStatusTransitionForUpdateResponse>
    {
        private static readonly string[] TranslationFieldNames = new[] { "Name", "Description" };
        private readonly ITransactionStatusTransitionRepository _repository; private readonly ITransactionStatusTransitionTranslationRepository _translationRepository; private readonly IApplicationLanguageProvider _languageProvider;
        public GetTransactionStatusTransitionForUpdateQueryHandler(ITransactionStatusTransitionRepository repository, ITransactionStatusTransitionTranslationRepository translationRepository, IApplicationLanguageProvider languageProvider) { _repository = repository; _translationRepository = translationRepository; _languageProvider = languageProvider; }
        public async Task<GetTransactionStatusTransitionForUpdateResponse> Handle(GetTransactionStatusTransitionForUpdateQuery request, CancellationToken cancellationToken)
        {
