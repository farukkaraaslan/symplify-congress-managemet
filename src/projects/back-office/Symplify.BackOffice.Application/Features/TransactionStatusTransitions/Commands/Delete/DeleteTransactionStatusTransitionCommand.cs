...
public class DeleteTransactionStatusTransitionCommand
    : IRequest<DeletedTransactionStatusTransitionResponse>, ISecuredRequest, ICacheRemoverRequest
{
    ...
    public class DeleteTransactionStatusTransitionCommandHandler
        : IRequestHandler<DeleteTransactionStatusTransitionCommand, DeletedTransactionStatusTransitionResponse>
    {
        ...
        public DeleteTransactionStatusTransitionCommandHandler(
        ...
        public async Task<DeletedTransactionStatusTransitionResponse> Handle(
            DeleteTransactionStatusTransitionCommand request,
