...
public class CreateEvaluationCriterionCommand : IRequest<CreatedEvaluationCriterionResponse>, ISecuredRequest, ICacheRemoverRequest
{
    ...
    public string[] Roles => new[] { EvaluationCriteriaOperationClaims.Admin, EvaluationCriteriaOperationClaims.Write, EvaluationCriteriaOperationClaims.Add };

    public class CreateEvaluationCriterionCommandHandler : IRequestHandler<CreateEvaluationCriterionCommand, CreatedEvaluationCriterionResponse>
    {
        ...
        public CreateEvaluationCriterionCommandHandler(
        ...
        public async Task<CreatedEvaluationCriterionResponse> Handle(CreateEvaluationCriterionCommand request, CancellationToken cancellationToken)
        {
            await _rules.DefaultTranslationShouldExist(request.Translations, cancellationToken);

            EvaluationCriterion entity = new()
            {
                Id = Guid.NewGuid(),
                Code = request.Code,
                Order = 0,
                Score = NormalizeScore(request.Score),
                IsActive = request.IsActive
            };

            EvaluationCriterion createdEntity = await _repository.AddAsync(entity);
            ...
            return _mapper.Map<CreatedEvaluationCriterionResponse>(createdEntity);
        }
        ...
        private async Task NormalizeVisibleOrdersAsync(
            EvaluationCriterion createdEntity,
            int requestedOrder,
            CancellationToken cancellationToken)
        {
