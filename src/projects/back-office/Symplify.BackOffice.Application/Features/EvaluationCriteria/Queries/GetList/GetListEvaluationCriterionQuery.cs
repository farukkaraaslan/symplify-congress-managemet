...
namespace Symplify.BackOffice.Application.Features.EvaluationCriteria.Queries.GetList;

public class GetListEvaluationCriterionQuery : IRequest<GetListResponse<GetListEvaluationCriterionListItemDto>>, ISecuredRequest, ICachableRequest
{
    ...
    public string CacheKey => $"GetListEvaluationCriteria({PageRequest.Page},{PageRequest.PageSize},{LanguageId},{Culture},{IsActive},{SearchText},{SortColumn},{SortDirection})";

    public string CacheGroupKey => "GetEvaluationCriteria";

    public TimeSpan? SlidingExpiration { get; }

    public class GetListEvaluationCriterionQueryHandler : IRequestHandler<GetListEvaluationCriterionQuery, GetListResponse<GetListEvaluationCriterionListItemDto>>
    {
        private readonly IEvaluationCriterionRepository _repository;
        private readonly IEvaluationCriterionTranslationRepository _translationRepository;
        ...
        public GetListEvaluationCriterionQueryHandler(
            IEvaluationCriterionRepository repository,
            IEvaluationCriterionTranslationRepository translationRepository,
        ...
        public async Task<GetListResponse<GetListEvaluationCriterionListItemDto>> Handle(
            GetListEvaluationCriterionQuery request,
            CancellationToken cancellationToken)
        {
            ...
            IQueryable<EvaluationCriterionTranslation> translationQuery = _translationRepository.Query();

            IPaginate<EvaluationCriterion> roots = await _repository.GetListAsync(
            ...
            List<EvaluationCriterionTranslation> translations = ids.Count == 0
                ? new List<EvaluationCriterionTranslation>()
                : translationQuery.Where(translation => ids.Contains(translation.EvaluationCriterionId)).ToList();

            List<GetListEvaluationCriterionListItemDto> items = roots.Items.Select(entity =>
            {
                List<EvaluationCriterionTranslation> rootTranslations = translations
                    .Where(translation => EqualityComparer<Guid>.Default.Equals(translation.EvaluationCriterionId, entity.Id))
                    .ToList();

                EvaluationCriterionTranslation? requestedTranslation = rootTranslations.FirstOrDefault(translation => translation.LanguageId == requestedLanguage.Id);
                EvaluationCriterionTranslation? displayTranslation = _fallbackResolver.Resolve(rootTranslations, requestedLanguage.Id, defaultLanguage.Id);

                return new GetListEvaluationCriterionListItemDto
                {
                    Id = entity.Id,
                    Code = entity.Code,
                    Order = entity.Order,
            ...
            return new GetListResponse<GetListEvaluationCriterionListItemDto>
            {
                Index = roots.Index,
                Size = roots.Size,
                Count = roots.Count,
        ...
        private static Expression<Func<EvaluationCriterion, bool>>? BuildPredicate(
            GetListEvaluationCriterionQuery request,
            IQueryable<EvaluationCriterionTranslation> translationQuery)
        {
            ...
            IQueryable<Guid> matchingTranslationRootIds = translationQuery
                ...
                .Select(translation => translation.EvaluationCriterionId);
        ...
        private static Func<IQueryable<EvaluationCriterion>, IOrderedQueryable<EvaluationCriterion>> BuildOrderBy(
            string? sortColumn,
            ...
            IQueryable<EvaluationCriterionTranslation> translationQuery)
        {
            ...
            return normalizedSortColumn switch
            {
                "name" => query => descending
                    ? query
                        .OrderByDescending(entity =>
                            translationQuery
                                .Where(translation => translation.EvaluationCriterionId == entity.Id && translation.LanguageId == requestedLanguageId)
                                .Select(translation => translation.Name)
                                .FirstOrDefault()
                            ?? translationQuery
                                .Where(translation => translation.EvaluationCriterionId == entity.Id && translation.LanguageId == defaultLanguageId)
                                .Select(translation => translation.Name)
                                .FirstOrDefault()
                            ?? string.Empty)
                ...
                "score" => query => descending
                    ? query.OrderByDescending(entity => entity.Score).ThenBy(entity => entity.Order).ThenBy(entity => entity.Id)
                    : query.OrderBy(entity => entity.Score).ThenBy(entity => entity.Order).ThenBy(entity => entity.Id),
