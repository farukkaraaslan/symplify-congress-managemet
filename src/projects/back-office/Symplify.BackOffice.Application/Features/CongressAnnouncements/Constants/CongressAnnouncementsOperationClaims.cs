namespace Symplify.BackOffice.Application.Features.CongressAnnouncements.Constants;

public static class CongressAnnouncementsOperationClaims
{
    private const string Section = "CongressAnnouncements";
