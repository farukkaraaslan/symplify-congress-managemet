...
window.Symplify.EvaluationCriteria.Delete = (function ($) {
    'use strict';

    const selectors = {
        form: '#deleteEvaluationCriterionForm',
        deleteButton: '.js-evaluation-criterion-delete-button'
    };

    function init() {
        $(document)
            .off('click.evaluation-criteriaDelete', selectors.deleteButton)
            .on('click.evaluation-criteriaDelete', selectors.deleteButton, confirmDelete);
    }
