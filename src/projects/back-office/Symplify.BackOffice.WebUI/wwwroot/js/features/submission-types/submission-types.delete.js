...
window.Symplify.SubmissionTypes.Delete = (function ($) {
    'use strict';

    const selectors = {
        form: '#deleteSubmissionTypeForm',
        deleteButton: '.js-submission-type-delete-button'
    };

    function init() {
        $(document)
            .off('click.submission-typesDelete', selectors.deleteButton)
            .on('click.submission-typesDelete', selectors.deleteButton, confirmDelete);
    }
