...
window.Symplify.TransactionStatusPhases.Create = (function ($) {
    ...
    function tryRenderValidationErrors($form, response) {
        ...
        removeAnyValidationSummary($form);
    ...
    function removeAnyValidationSummary($form) {
        if (!$form || !$form.length) return;

        $form.find('.js-validation-summary, .js-lookup-validation-summary, [data-symplify-validation-summary], [data-valmsg-summary="true"], .validation-summary-errors, .validation-summary-valid')
            .addClass('d-none')
            .empty();
    }
