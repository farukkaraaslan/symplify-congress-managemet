...
window.Symplify.TransactionStatusPhases.Update = (function ($) {
    ...
    function init() {
        ...
        $(document).off('shown.bs.modal.transactionstatusphaseUpdate', selectors.modal).on('shown.bs.modal.transactionstatusphaseUpdate', selectors.modal, function () { initializeValidation($(selectors.form)); bindSwitches($(selectors.form)); });
    }
