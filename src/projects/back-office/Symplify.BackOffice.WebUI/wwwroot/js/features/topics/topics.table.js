...
window.Symplify.Topics.Table = (function ($) {
    'use strict';
    ...
    function init() {
        ...
        $table
            .off('order.dt.topicsTable search.dt.topicsTable page.dt.topicsTable draw.dt.topicsTable')
            .on('order.dt.topicsTable search.dt.topicsTable page.dt.topicsTable draw.dt.topicsTable', function () {
    ...
    function renderActions(id) {
        ...
        return '' +
            '<div class="d-flex align-items-center justify-content-end gap-2">' +
                '<button type="button" class="w-40-px h-40-px bg-primary-50 text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center js-lookup-update-button js-topic-update-button" data-id="' + escapeHtml(id) + '" title="' + escapeHtml(editText) + '" aria-label="' + escapeHtml(editText) + '">' +
                    '<i class="ri-pencil-line"></i>' +
                '</button>' +
                '<button type="button" class="w-40-px h-40-px bg-danger-50 text-danger-600 rounded-circle d-inline-flex align-items-center justify-content-center js-lookup-delete-button js-topic-delete-button" data-id="' + escapeHtml(id) + '" title="' + escapeHtml(deleteText) + '" aria-label="' + escapeHtml(deleteText) + '">' +
    ...
    function getTexts() {
        return window.Symplify.Topics.texts ||
