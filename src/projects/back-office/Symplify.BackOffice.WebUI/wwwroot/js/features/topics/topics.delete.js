...
window.Symplify.Topics.Delete = (function ($) {
    'use strict';

    const selectors = {
        form: '#deleteTopicForm',
        deleteButton: '.js-topic-delete-button'
    };

    function init() {
        $(document)
            .off('click.topicsDelete', selectors.deleteButton)
            .on('click.topicsDelete', selectors.deleteButton, confirmDelete);
    }
