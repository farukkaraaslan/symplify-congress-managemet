...
window.Symplify.Topics.Create = (function ($) {
    'use strict';
    ...
    function init() {
        ...
        $(document)
            .off('submit.topicsCreate', selectors.form)
            .on('submit.topicsCreate', selectors.form, submitForm);

        $(document)
            .off('shown.bs.modal.topicsCreate', selectors.modal)
            .on('shown.bs.modal.topicsCreate', selectors.modal, function () {
                initializeValidation($(selectors.form));
                bindStatusSwitch($(selectors.form));
            });

        $(document)
            .off('hidden.bs.modal.topicsCreate', selectors.modal)
            .on('hidden.bs.modal.topicsCreate', selectors.modal, resetForm);
    }
        ...
        postForm($form)
            .done(function (response) {
                ...
                if (window.Symplify.Topics.Table) {
                    window.Symplify.Topics.Table.reload(true);
                }
