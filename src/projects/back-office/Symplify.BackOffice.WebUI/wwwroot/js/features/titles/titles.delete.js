...
window.Symplify.Titles.Delete = (function ($) {
    'use strict';

    const selectors = {
        form: '#deleteTitleForm',
        deleteButton: '.js-title-delete-button'
    };

    function init() {
        $(document)
            .off('click.titlesDelete', selectors.deleteButton)
            .on('click.titlesDelete', selectors.deleteButton, confirmDelete);
    }
