...
window.Symplify.EventRooms.Delete = (function ($) {
    'use strict';

    const selectors = {
        form: '#deleteEventRoomForm',
        deleteButton: '.js-event-room-delete-button'
    };

    function init() {
        $(document)
            .off('click.event-roomsDelete', selectors.deleteButton)
            .on('click.event-roomsDelete', selectors.deleteButton, confirmDelete);
    }
