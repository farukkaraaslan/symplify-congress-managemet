...
window.Symplify.TransactionStatusTransitions.Delete = (function ($) {
    'use strict';

    const selectors = {
        form: '#deleteTransactionStatusTransitionForm',
        deleteButton: '.js-transaction-status-transition-delete-button'
    };

    function init() {
        $(document)
            .off('click.transactionStatusTransitionsDelete', selectors.deleteButton)
            .on('click.transactionStatusTransitionsDelete', selectors.deleteButton, confirmDelete);
    }
