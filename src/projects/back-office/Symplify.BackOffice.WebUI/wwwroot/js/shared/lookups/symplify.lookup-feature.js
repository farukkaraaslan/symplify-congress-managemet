...
window.Symplify.LookupFeature = (function ($) {
    ...
    function showAjaxError(xhr) {
        ...
        console.error(xhr?.responseJSON?.message || getText('genericError', 'İşlem sırasında hata oluştu.'));
    }

    function showWarning(message) {
        if (window.Symplify.Ajax && typeof window.Symplify.Ajax.showWarning === 'function') {
            window.Symplify.Ajax.showWarning(message);
        }
    }
