...
public class Submission : Entity<Guid>, IEntityTimestamps, IAuditable, IAggregateRoot
{
    ...
    public virtual ICollection<SubmissionFile> Files { get; set; } = new HashSet<SubmissionFile>();
    public virtual SubmissionExhibitionDetail? ExhibitionDetail { get; set; }
    public virtual ICollection<SubmissionAcceptanceLetter> AcceptanceLetters { get; set; } = new HashSet<SubmissionAcceptanceLetter>();
}
