...
public class CongressAnnouncement : Entity<Guid>, IEntityTimestamps, IAuditable
{
    ...
    public virtual ICollection<CongressAnnouncementTranslation> Translations { get; set; } =
        new HashSet<CongressAnnouncementTranslation>();
}
