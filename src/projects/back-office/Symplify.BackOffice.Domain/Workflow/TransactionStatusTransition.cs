...
public class TransactionStatusTransition : Entity<int>, IEntityTimestamps, IAuditable
{
    ...
    public virtual ICollection<WorkflowTransitionCondition> Conditions { get; set; } =
        new HashSet<WorkflowTransitionCondition>();

    public virtual ICollection<WorkflowTransitionEffect> Effects { get; set; } =
        new HashSet<WorkflowTransitionEffect>();
