...
public sealed class SubmissionTypeConfiguration : IEntityTypeConfiguration<EntityType>
{
    public void Configure(EntityTypeBuilder<EntityType> builder)
    {
        ...
        builder.Property(entity => entity.FormProfile).HasConversion<int>().IsRequired().HasDefaultValue(Symplify.BackOffice.Domain.Enums.SubmissionFormProfile.AcademicAbstract);
    }
}
