...
using EntityType = Symplify.BackOffice.Domain.Workflow.WorkflowTemplateTranslation;

namespace Symplify.BackOffice.Persistence.EntityConfigurations;

public sealed class WorkflowTemplateTranslationConfiguration : IEntityTypeConfiguration<EntityType>
{
    public void Configure(EntityTypeBuilder<EntityType> builder)
    {
        builder.ToTable("WorkflowTemplateTranslations");
    ...
    private static void ConfigureRelationships(EntityTypeBuilder<EntityType> builder)
    {
        builder.HasOne(entity => entity.WorkflowTemplate)
            .WithMany(template => template.Translations)
