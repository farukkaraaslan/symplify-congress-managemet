...
public static class CommonResourceSeedDefinitions
{
    public static IReadOnlyCollection<ResourceSeedDefinition> All { get; } = new List<ResourceSeedDefinition>
    {
        ...
        new("BackOffice.Common", "BackOffice.Common.Business.ReorderEntityNotFound", "Sıralanacak kayıt bulunamadı.", "The record to reorder was not found."),
        new("BackOffice.Common", "BackOffice.Common.File.FileTooLarge", "Seçilen dosya izin verilen boyuttan büyük.", "The selected file exceeds the allowed size."),
        new("BackOffice.Common", "BackOffice.Common.File.InvalidFile", "Seçilen dosya bu alan için uygun değil.", "The selected file is not valid for this field."),
        new("Common", "Common.View", "Görüntüle", "View"),
    };
}
