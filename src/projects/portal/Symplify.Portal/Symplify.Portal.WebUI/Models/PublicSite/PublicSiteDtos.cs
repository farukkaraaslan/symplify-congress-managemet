namespace Symplify.Portal.WebUI.Models.PublicSite;
...
public sealed class PublicContactResponse
{
    ...
    // Legacy fallback. Public API ContactEmails listesini döndürmeye başladıktan
    // sonra yalnızca geriye uyumluluk amacıyla kullanılacaktır.
